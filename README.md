...
Las etapas utilizadas para la elaboracion de este poryecto fueron: Exploracion,limpieza,analisis y visualizacion de datos, concluyendo con Insight relevantes para la toma de decisiones final.
